		...
		.controller('portifolioController', ['$scope', '$filter', '$sce', '$timeout', '$http', function ($scope, $filter, $sce, $timeout, $http) {
			...
			$scope.changeLanguage = (language) => {
				if (language === 'BR') {
					...
					$("#job-desc-accenture").text("Desenvolvimento de aplicaçoes utilizando Node Js e Angular 6.");
					...
					$("#s2m").text("Sistema desenvolvido diretamente para o Presidente do Santander Brasil, com a função de fornecer gráficos e métricas de todos os gestores de entrega do banco, fornecendo assim material para análise individual e geral da saúde dos projetos do Santander.");
					...
					$("#chocobo").text("Calendário em AngularJS para escolher um intervalo de datas.");
					...
					$("#cooldatagrid").text("Biblioteca em C# para melhorar a interface gráfica de uma TableView");
				...
				if (language === 'SP') {
					...
					$("#s2m").text("Sistema desarrollado directamente para el Presidente del Santander Brasil, con la función de proporcionar gráficos y métricas de todos los gestores de entrega del banco, proporcionando así material para análisis individual y general de la salud de los proyectos del Santander.");
					...
					$("#chocobo").text("Calendario en AngularJS para elegir un intervalo de fechas.");
					...
					$("#cooldatagrid").text("Biblioteca en C # para mejorar la interfaz gráfica de una tabla.");
				...
				if (language === 'US' || language === 'UK') {
					...
					$("#s2m").text("System developed directly for the President of Santander Brasil, with the function of providing graphs and metrics of all the bank's delivery managers, thus providing material for individual and general health analysis of Santander's projects.");
					...
					$("#cooldatagrid").text("C # library to improve the graphical interface of a Table.");
